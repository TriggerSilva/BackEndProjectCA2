...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('cameraModels.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('cameraModels.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('cameraModels.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.cameraModels.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('cameraModels.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('cameraModels.xml', function(err, result) {
      ...
      delete result.cameraModels.product-type[obj.section].product[obj.entree];
