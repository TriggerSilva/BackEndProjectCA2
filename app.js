...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('carameModels.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('carameModels.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('carameModels.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('carameModels.xml', result, function(err) {
